...
IC bool CALifeSpawnRegistry::spawned_item(SPAWN_GRAPH::Vertex* vertex, SPAWN_IDS& objects)
{
...
void CALifeSpawnRegistry::fill_new_spawns_single(
    SPAWN_GRAPH::Vertex* vertex, SPAWN_IDS& spawns, ALife::_TIME_ID game_time, SPAWN_IDS& objects)
{

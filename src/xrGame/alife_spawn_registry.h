...
protected:
    ...
    void fill_new_spawns_single(SPAWN_GRAPH::Vertex* vertex, xr_vector<ALife::_SPAWN_ID>& spawns,
        ALife::_TIME_ID game_time, xr_vector<ALife::_SPAWN_ID>& objects);
    void fill_new_spawns(SPAWN_GRAPH::Vertex* vertex, xr_vector<ALife::_SPAWN_ID>& spawns, ALife::_TIME_ID game_time,
    ...
    IC bool spawned_item(SPAWN_GRAPH::Vertex* vertex, xr_vector<ALife::_SPAWN_ID>& objects);

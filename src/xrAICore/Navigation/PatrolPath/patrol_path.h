...
public:
    ...
    IC const Vertex* point(shared_str name) const;
    template <typename T>
    IC const Vertex* point(const Fvector& position, const T& evaluator) const;
    IC const Vertex* point(const Fvector& position) const;

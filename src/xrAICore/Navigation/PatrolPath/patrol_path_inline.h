...
IC const CPatrolPath::Vertex* CPatrolPath::point(shared_str name) const
{
...
template <typename T>
IC const CPatrolPath::Vertex* CPatrolPath::point(const Fvector& position, const T& evaluator) const
{
    const CPatrolPath::Vertex* nearest = 0;
...
IC const CPatrolPath::Vertex* CPatrolPath::point(const Fvector& position) const
{

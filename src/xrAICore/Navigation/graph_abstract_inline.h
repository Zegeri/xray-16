...
IC void CAbstractGraph::add_vertex(const _data_type& data, const _vertex_id_type& vertex_id)
{
    ...
    m_vertices.insert(std::make_pair(vertex_id, new Vertex(data, vertex_id, &m_edge_count)));
}
...
{
    Vertex* _vertex0 = vertex(vertex_id0);
    VERIFY(_vertex0);
    Vertex* _vertex1 = vertex(vertex_id1);
    VERIFY(_vertex1);
...
{
    Vertex* _vertex = vertex(vertex_id0);
    VERIFY(_vertex);
...
TEMPLATE_SPECIALIZATION
IC const typename CAbstractGraph::Vertex* CAbstractGraph::vertex(const _vertex_id_type& vertex_id) const
{
...
TEMPLATE_SPECIALIZATION
IC typename CAbstractGraph::Vertex* CAbstractGraph::vertex(const _vertex_id_type& vertex_id)
{
    vertex_iterator I = m_vertices.find(vertex_id);
    if (m_vertices.end() == I)
        return (0);
...
TEMPLATE_SPECIALIZATION
IC const typename CAbstractGraph::Edge* CAbstractGraph::edge(
    const _vertex_id_type& vertex_id0, const _vertex_id_type& vertex_id1) const
{
    const Vertex* _vertex = vertex(vertex_id0);
    if (!_vertex)
        return (0);
...
TEMPLATE_SPECIALIZATION
IC typename CAbstractGraph::Edge* CAbstractGraph::edge(
...
TEMPLATE_SPECIALIZATION
IC void CAbstractGraph::begin(const Vertex* vertex, const_iterator& b, const_iterator& e) const
{
    VERIFY(vertex);

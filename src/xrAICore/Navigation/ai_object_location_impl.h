...
IC void CAI_ObjectLocation::game_vertex(Vertex const* game_vertex)
{
...
IC const GameGraph::CVertex* CAI_ObjectLocation::game_vertex() const
{
    VERIFY(ai().game_graph().valid_vertex_id(m_game_vertex_id));
    return (ai().game_graph().vertex(m_game_vertex_id));
}

IC void CAI_ObjectLocation::level_vertex(LevelVertex const* level_vertex)
{
...
IC const LevelGraph::CVertex* CAI_ObjectLocation::level_vertex() const
{
